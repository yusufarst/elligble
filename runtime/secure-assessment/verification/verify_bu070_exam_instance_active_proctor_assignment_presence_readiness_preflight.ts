...
async function runVerification() {
  ...
  try {
    ...
    if (afterExamInstancesCount !== beforeExamInstancesCount + 4) throw new Error('Exam instance count mutated unexpectedly');
