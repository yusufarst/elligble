...
| `docs/build/BUILD_PHASE_INDEX.md` | Build Phase Control and Index. Status: ACTIVE v0.1.85 / SHA256: 85D2A2C49D68B8C050B3F0F797A5223F77A7030015783A0E726D8DCF4E1BC270) | DYNAMIC BUILD CONTROL / DOES NOT SUPERSEDE LOCKED SOURCES | PHASE: Build |
...
| `docs/build/units/BU-021_SECURE_ASSESSMENT_CAPABILITY_MATRIX_ACTIVE_SESSION_CONTINUITY_EVIDENCE_SYNCHRONIZATION_BOOTSTRAP.md` | BU-021 Specification - Secure Assessment Capability Matrix Active-Session Continuity Evidence Synchronization Bootstrap. Status: BU-021 v1.0.0 / FAST-TRACK MAIN EXECUTION COMPLETE / MAIN-EXECUTION REPOSITORY FINALIZED / AWAITING CONTROLLER PHYSICAL AUDIT / CONTROLLER PHYSICAL AUDIT: NOT YET / FAST-TRACK LIFECYCLE CLOSE: NOT YET / DONE: NO / FULL BU-021 REPOSITORY FINALIZED: NO. (B2E7C96F81A0436A440E20EC0D987231FA4DC30E6AF4A439FA0A79ABAEE7AC08) | BUILD UNIT SPEC | PHASE: Build |
