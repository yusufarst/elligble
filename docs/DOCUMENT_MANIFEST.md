...
| `docs/build/BUILD_PHASE_INDEX.md` | Build Phase Control and Index. Status: ACTIVE / CONTROL BASELINE. Version: 0.1.50. (D65F159FCFA01FA79E795528A5AA34C06F6177AC425146A3A6A7BA400846A8B4) | DYNAMIC BUILD CONTROL / DOES NOT SUPERSEDE LOCKED SOURCES | PHASE: Build |
...
| `docs/build/units/BU-010_SECURE_ASSESSMENT_IDEMPOTENT_SUBMISSION_RUNTIME_BOOTSTRAP.md` | Secure Assessment Idempotent Submission Runtime Bootstrap. Status: IMPLEMENTATION READINESS / REPOSITORY FINALIZED / POST-READINESS LIFECYCLE SYNC PENDING CONTROLLER AUDIT. (FAB955FA6DEBC4E16A6383551A3D711624E7D9DEF72C2CC9F7B747B05864B96D) | BUILD UNIT SPEC | PHASE: Build |
