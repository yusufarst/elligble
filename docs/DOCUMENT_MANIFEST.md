...
| `docs/build/BUILD_PHASE_INDEX.md` | Build Phase Control and Index. Status: ACTIVE / CONTROL BASELINE. Version: 0.1.26. (D63ECCBED65F2EA87F9875194EAC3AE5A7F93BA014EA766A485D6374DBD58C40) | DYNAMIC BUILD CONTROL / DOES NOT SUPERSEDE LOCKED SOURCES | PHASE: Build |
...
| `docs/build/units/BU-007_SECURE_ASSESSMENT_SERVER_AUTHORITATIVE_TIMER_CORE_STATE_PERSISTENCE_BOOTSTRAP.md` | BU-007 Specification — Secure Assessment Server-Authoritative Timer Core State Persistence Bootstrap. Status: REGISTRATION CANDIDATE / NOT STARTED. (A308400DD405F1E7A59195F0F2AF51DCB9A93AF525FD657558F3DC7E05BB3AA3) | BUILD UNIT SPEC | PHASE: Build |
