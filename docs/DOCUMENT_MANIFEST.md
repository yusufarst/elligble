...
| `docs/build/BUILD_PHASE_INDEX.md` | Build Phase Control and Index. Status: ACTIVE / CONTROL BASELINE. Version: 0.1.29. (A4B2CCC0D5C239035FB68CBEAB7CAADC75A0AB06828F12DA3D64CE573BE2E8E0) | DYNAMIC BUILD CONTROL / DOES NOT SUPERSEDE LOCKED SOURCES | PHASE: Build |
...
| `docs/build/units/BU-007_SECURE_ASSESSMENT_SERVER_AUTHORITATIVE_TIMER_CORE_STATE_PERSISTENCE_BOOTSTRAP.md` | BU-007 Specification — Secure Assessment Server-Authoritative Timer Core State Persistence Bootstrap. Status: REGISTERED / READINESS REPOSITORY FINALIZED / IMPLEMENTATION NOT STARTED. (FBC3168F1764F5706FB72825293CC2C8A8B44F760753427DFB04F79625C4F2D9) | BUILD UNIT SPEC | PHASE: Build |
