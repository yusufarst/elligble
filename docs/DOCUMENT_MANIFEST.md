...
| `docs/build/BUILD_PHASE_INDEX.md` | Build Phase Control and Index. Status: ACTIVE / CONTROL BASELINE. Version: 0.1.56. (1942F626694B4ED7953CE58D58887A5BB0FDFEB9286C2FB2BA3CDB53DE94D632) | DYNAMIC BUILD CONTROL / DOES NOT SUPERSEDE LOCKED SOURCES | PHASE: Build |
...
| `docs/build/units/BU-011_SECURE_ASSESSMENT_RECONNECT_RESUME_AUTHORITATIVE_STATE_READBACK_RUNTIME_BOOTSTRAP.md` | BU-011 Specification - Secure Assessment Reconnect / Resume Authoritative State Readback Runtime Bootstrap. Status: PENDING CONTROLLER PHYSICAL AUDIT. | BUILD UNIT SPEC | PHASE: Build |
