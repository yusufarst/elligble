...
| `docs/build/BUILD_PHASE_INDEX.md` | Build Phase Control and Index. Status: ACTIVE / CONTROL BASELINE. Version: 0.1.27. (696BAED35B82937E02C7EEC74E9881D7D0CF657AFBC69675B2B9090936FEB523) | DYNAMIC BUILD CONTROL / DOES NOT SUPERSEDE LOCKED SOURCES | PHASE: Build |
...
| `docs/build/units/BU-007_SECURE_ASSESSMENT_SERVER_AUTHORITATIVE_TIMER_CORE_STATE_PERSISTENCE_BOOTSTRAP.md` | BU-007 Specification — Secure Assessment Server-Authoritative Timer Core State Persistence Bootstrap. Status: REGISTERED / REGISTRATION REPOSITORY FINALIZED / NOT STARTED. (BDE6873A4181CEADF7CF3E88C843B3A632FB3950225D08B5CED7D17D8ABCD898) | BUILD UNIT SPEC | PHASE: Build |
