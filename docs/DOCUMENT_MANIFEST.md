...
| `docs/build/BUILD_PHASE_INDEX.md` | Build Phase Control and Index. Status: ACTIVE / CONTROL BASELINE. Version: 0.1.47. (FC58AB35843334A7861E0F2AA94E063C3B35511B49D5D562AE9F5B12C2B825BF) | DYNAMIC BUILD CONTROL / DOES NOT SUPERSEDE LOCKED SOURCES | PHASE: Build |
...
| `docs/build/units/BU-010_SECURE_ASSESSMENT_IDEMPOTENT_SUBMISSION_RUNTIME_BOOTSTRAP.md` | Secure Assessment Idempotent Submission Runtime Bootstrap. Status: REGISTRATION CANDIDATE / CONTROLLER AUDIT PASS / OWNER ACCEPTANCE COMPLETE / GIT FINALIZATION PENDING. (B7D6BEDF8CE6044A513673014789496219FE1E64D9382F15D878D8FDB8705AA5) | BUILD UNIT SPEC | PHASE: Build |
