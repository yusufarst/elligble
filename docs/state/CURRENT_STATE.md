...
ACTIVE UNIT           → NONE
NEXT SAFE ACTION      → MAIN PROJECT CONTROL 06 PHYSICAL VERIFICATION OF BUILD UNIT FAST-TRACK CONTROL v1 ACTIVATION
NEXT UNIT             → NOT YET REGISTERED
NEXT BUILD UNIT       → NOT YET REGISTERED
NEXT STAGE            → BUILD UNIT FAST-TRACK CONTROL v1 ACTIVATION PHYSICAL VERIFICATION
MB-00                 → LOCKED v1.0.0
MB-01                 → LOCKED v1.0.0
MB-02                 → LOCKED v1.0.0
MB-03                 → LOCKED v1.0.0
