...
**Version:** 1.4.41
**Canonical:** YES
**Supersedes:** CURRENT_STATE v1.4.40
...
ACTIVE UNIT           → NONE
NEXT SAFE ACTION      → REGISTER THE NEXT SECURE-ASSESSMENT-PRIORITY BUILD UNIT
NEXT UNIT             → NOT YET REGISTERED
NEXT STAGE            → NEXT BUILD UNIT REGISTRATION
MB-00                 → LOCKED v1.0.0
MB-01                 → LOCKED v1.0.0
MB-02                 → LOCKED v1.0.0
MB-03                 → LOCKED v1.0.0
...
Next unit is NOT YET REGISTERED.
```
