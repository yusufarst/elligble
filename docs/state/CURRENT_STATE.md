...
**Version:** 1.5.169
**Canonical:** YES
**Supersedes:** CURRENT_STATE v1.5.168
...
### 2. Navigation
**LAST COMPLETED UNIT:** BU-046
**LAST COMPLETED BUILD UNIT:** BU-046 — Academic Core Student Enrollment Core State Persistence Bootstrap
**ACTIVE UNIT:** BU-047
**ACTIVE BUILD UNIT:** BU-047 — Secure Assessment Exam Participant Academic-Enrollment Context Persistence Bootstrap
**NEXT UNIT:** NONE / NOT AUTHORIZED
**NEXT BUILD UNIT:** NONE / NOT AUTHORIZED
**CURRENT CONTROLLER:** MAIN PROJECT CONTROL 09
**CURRENT RESPONSIBILITY:** BU-047 CONTROLLER PHYSICAL RE-AUDIT
**NEXT SAFE ACTION:** MAIN PROJECT CONTROL 09 — BU-047 CONTROLLER PHYSICAL RE-AUDIT
**NEXT STAGE:** BU-047 FAST-TRACK STAGE 3 — CONTROLLER PHYSICAL RE-AUDIT
...
→ ACTIVE CONTROLLER / BU-047 CONTROLLER PHYSICAL RE-AUDIT
## Recovery Status
