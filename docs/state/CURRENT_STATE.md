...
**Version:** 1.5.200
**Canonical:** YES
**Supersedes:** CURRENT_STATE v1.5.199
...
### 2. Navigation
**LAST COMPLETED UNIT:** BU-054
**LAST COMPLETED BUILD UNIT:** BU-054 — Secure Assessment Exam Instance Operational Window Persistence Bootstrap
**ACTIVE UNIT:** BU-055
**ACTIVE BUILD UNIT:** BU-055 — Secure Assessment Exam Instance Draft-to-Scheduled Lifecycle Transition Runtime Bootstrap
**NEXT UNIT:** NOT YET REGISTERED
**NEXT BUILD UNIT:** NOT YET REGISTERED
**CURRENT CONTROLLER:** MAIN PROJECT CONTROL 09
**CURRENT RESPONSIBILITY:** BU-055 — STAGE 3 CONTROLLER PHYSICAL AUDIT
**NEXT SAFE ACTION:** MAIN PROJECT CONTROL 09 — BU-055 STAGE 3 CONTROLLER PHYSICAL AUDIT
**NEXT STAGE:** BU-055 FAST-TRACK STAGE 3 — CONTROLLER PHYSICAL AUDIT
