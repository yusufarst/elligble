...
**Version:** 1.5.162
**Canonical:** YES
**Supersedes:** CURRENT_STATE v1.5.161
...
### 2. Navigation
**LAST COMPLETED UNIT:** BU-045
**LAST COMPLETED BUILD UNIT:** BU-045 — Secure Assessment Teacher-Managed Exam Instance Creation Runtime Bootstrap
**ACTIVE UNIT:** BU-046
**ACTIVE BUILD UNIT:** BU-046 — Academic Core Student Enrollment Core State Persistence Bootstrap
**NEXT UNIT:** NONE
**NEXT BUILD UNIT:** NONE
**CURRENT CONTROLLER:** MAIN PROJECT CONTROL 09
**CURRENT RESPONSIBILITY:** BU-046 CONTROLLER PHYSICAL RE-AUDIT
**NEXT SAFE ACTION:** MAIN PROJECT CONTROL 09 — BU-046 CONTROLLER PHYSICAL RE-AUDIT
**NEXT STAGE:** BU-046 FAST-TRACK STAGE 3 — CONTROLLER PHYSICAL RE-AUDIT
