...
**Version:** 1.5.177
**Canonical:** YES
**Supersedes:** CURRENT_STATE v1.5.176
...
### 2. Navigation
**LAST COMPLETED UNIT:** BU-048
**LAST COMPLETED BUILD UNIT:** BU-048 — Secure Assessment Exam Participant Academic-Enrollment Assignment Context Runtime Bootstrap
**ACTIVE UNIT:** BU-049
**ACTIVE BUILD UNIT:** BU-049 — Secure Assessment Exam Participant Academic-Enrollment Assignment Write Runtime Bootstrap
**NEXT UNIT:** NONE
**NEXT BUILD UNIT:** NONE
**CURRENT CONTROLLER:** MAIN PROJECT CONTROL 09
**CURRENT RESPONSIBILITY:** BU-049 CONTROLLER PHYSICAL AUDIT
**NEXT SAFE ACTION:** MAIN PROJECT CONTROL 09 — BU-049 CONTROLLER PHYSICAL AUDIT
**NEXT STAGE:** BU-049 FAST-TRACK STAGE 3 — CONTROLLER PHYSICAL AUDIT
