...
**Version:** 1.5.267
**Canonical:** YES
**Supersedes:** CURRENT_STATE v1.5.266
...
- **FIRST TARGETED REMEDIATION FINALIZATION PROCESS DEVIATIONS:** RECORDED
  - Antigravity used `git add .` despite exact-path staging prohibition
  - Antigravity used `git checkout docs/DOCUMENT_MANIFEST.md` despite checkout/rollback prohibition
  - Antigravity UI showed background processes while foreground-only execution was required
  - Agent final report incorrectly stated PROCESS DEVIATIONS NONE / BACKGROUND TASKIFIED NO
