...
**Version:** 1.4.73
**Canonical:** YES
**Supersedes:** CURRENT_STATE v1.4.72
...
ACTIVE UNIT           → BU-008 — REGISTRATION CANDIDATE
NEXT SAFE ACTION      → MAIN PROJECT CONTROL 05 AUDIT OF BU-008 REGISTRATION PACKAGE
NEXT UNIT             → BU-008 — REGISTRATION CANDIDATE
NEXT BUILD UNIT       → BU-008 — REGISTRATION CANDIDATE
NEXT STAGE            → MAIN PROJECT CONTROL 05 AUDIT OF BU-008 REGISTRATION PACKAGE
MB-00                 → LOCKED v1.0.0
MB-01                 → LOCKED v1.0.0
MB-02                 → LOCKED v1.0.0
MB-03                 → LOCKED v1.0.0
