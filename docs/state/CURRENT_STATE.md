...
**Version:** 1.4.96
**Canonical:** YES
**Supersedes:** CURRENT_STATE v1.4.95
...
ACTIVE UNIT           → NONE
NEXT SAFE ACTION      → MAIN PROJECT CONTROL 06 FINAL PHYSICAL VERIFICATION OF BU-010 LIFECYCLE CLOSE
NEXT UNIT             → NOT YET REGISTERED
NEXT BUILD UNIT       → NOT YET REGISTERED
NEXT STAGE            → BU-010 FINAL LIFECYCLE-CLOSE PHYSICAL VERIFICATION
MB-00                 → LOCKED v1.0.0
MB-01                 → LOCKED v1.0.0
MB-02                 → LOCKED v1.0.0
MB-03                 → LOCKED v1.0.0
